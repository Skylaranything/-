...
def save_image_with_opencv(image_array, output_path):
    # 使用OpenCV直接保存图像，避免Matplotlib的干扰
    ...
    for imgname in os.listdir(input_folder_path):
        if imgname.endswith('.jpg'):
            try:
                ...
                save_image_with_opencv(plate_image, output_path)
...
if __name__ == "__main__":
    input_folder_path = "data1"  # 输入文件夹路径
